...
var audiostring = "https://d3jyhm0tuhiy7c.cloudfront.net/" + audionum.toString() + ".mp3"
var lonval = -74.00597
var latval = 40.71427
...
const createScene =  function () {
  ...
  //camera shit
  var camera = new BABYLON.FollowCamera("Camera1", new BABYLON.Vector3(0, 0, -750), scene)
  var camera2 = new BABYLON.FollowCamera("Camera1", new BABYLON.Vector3(0, 50, -10), scene)
  ...
  skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("https://d3jyhm0tuhiy7c.cloudfront.net/skybox", scene)
  ...
  var button1 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but1", "About", "https://d3jyhm0tuhiy7c.cloudfront.net/about.jpeg")
  ...
  var button2 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but2", "", "https://d3jyhm0tuhiy7c.cloudfront.net/github.png")
  ...
  var button3 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but3", "", "https://d3jyhm0tuhiy7c.cloudfront.net/mail.jpeg")
  ...
  var button4 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but4", "", "https://d3jyhm0tuhiy7c.cloudfront.net/music.png")
  ...
  var button5 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but5", "", "https://d3jyhm0tuhiy7c.cloudfront.net/sachiniyer.jpg")
  ...
  var button6 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but6", "", "https://d3jyhm0tuhiy7c.cloudfront.net/secret.jpeg")
  ...
  var meshTask = assetsManager.addMeshTask("tesla task", "", "", "https://d3jyhm0tuhiy7c.cloudfront.net/tesla.glb")
  ...
  meshTask.onSuccess = function (task) {
		...
		const animtla = new BABYLON.Animation("carAnimation", "position.z", 30, BABYLON.Animation.ANIMATIONTYPE_FLOAT, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE)
  ...
  for (var row = 0; row < subdivisions.h; row++) {
	    ...
	    material.diffuseTexture = new BABYLON.Texture(
				"https://stamen-tiles.a.ssl.fastly.net/watercolor/" + zoom + "/" + (xTileBase + col) + "/" + (yTileBase - row) + ".jpg",
				scene
	    )
...
function success(position) {
	...
	console.log("This is localized tiling, so the map that you see is based off your browser's longitude and latitude. If you get red and black squares, it's cause you not cool enough to be drawn by stamen watercolor map")
	console.log(lonval)
	console.log(latval)
...
function error(err) {
	console.log("Hey, I see that you have blocked location tracking. If you want to turn it on I pinky promise not to track it. I only use it to do some localized tiling cool stuff. I defaulted it to new york, cause new york is cool")
	const scene = createScene()
	engine.runRenderLoop(function () {
		scene.render()
	})
