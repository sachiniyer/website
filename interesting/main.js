...
window.onload = function () {
  ...
  const createScene = function () {
    ...
    var button1 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but1", "About", "./about.jpeg")
    ...
    var button2 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but2", "", "./github.png")
    ...
    var button3 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but3", "", "./mail.jpeg")
    ...
    var button4 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but4", "", "./music.png")
    ...
    var button5 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but5", "", "./sachiniyer.jpg")
    ...
    var button6 = BABYLON.GUI.Button.CreateImageWithCenterTextButton("but6", "", "./secret.jpeg")
    ...
    var meshTask = assetsManager.addMeshTask("tesla task", "", "", "./tesla.glb")
